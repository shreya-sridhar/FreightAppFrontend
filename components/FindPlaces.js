...
function GooglePlacesInput(props) {
  ...
  const currentLocation = {
    ...
    geometry: { location: { lat: props.latitude, lng: props.longitude } },
  };
    ...
    <View style={{ height: "100%" }} keyboardShouldPersistTaps="always">
      <GooglePlacesAutocomplete
        ...
        query={{
          ...
          key: "AIzaSyBAeaMywiXmsyhhPIabeTCZxBq6FqLAGWU",
        ...
        styles={{
          container: {
            position: "absolute",
            top: Platform.select({ ios: 100, android: 75 }),
            width: "100%",
          },
          textInputContainer: {
            flex: 1,
      ...
      <GooglePlacesAutocomplete
        ...
        styles={{
          container: {
            position: "absolute",
            top: Platform.select({ ios: 150, android: 130 }),
            width: "100%",
          },
          textInputContainer: {
            flex: 1,
