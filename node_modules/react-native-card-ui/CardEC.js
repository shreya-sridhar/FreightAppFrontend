...
export class CardEcomTwo extends Component<Props> {
  ...
  render() {
    const {title, subTitle, price, image} = this.props;
    return (
      <View
        style={{
          backgroundColor: "#fff",
...
export class CardEcomThree extends Component<Props> {
  ...
  render() {
    const {title, subTitle, price, image, buttonText, buttonColor} = this.props;
    return (
      <View
        style={{
          backgroundColor: "#fff",
  ...
  render() {
    ...
    return (
      <View
        ...
        <ImageBackground borderRadius={12} source={image} style={{}}>
          <View
            style={{
